...
def _save_config_file(model_checkpoints_folder):
    if not os.path.exists(model_checkpoints_folder):
        ...
        shutil.copy('./config_ft_matbench_test.yaml', os.path.join(model_checkpoints_folder, 'config_ft.yaml'))
...
class FineTune(object):
    def __init__(self, config):
        ...
        self.model_dir = '.' + self.config['fine_tune_from']
        ...
        _, _ , self.test_loader = get_train_val_test_loader(
    ...
    def test(self):
        # test steps
        model_path = os.path.join(self.model_dir, 'checkpoints', 'model.pth')
        print(model_path)
        ...
        #self.model.train()self.writer.log_dir
...
if __name__ == "__main__":
    config = yaml.load(open("config_ft_matbench_test.yaml", "r"), Loader=yaml.FullLoader)
    print(config)
