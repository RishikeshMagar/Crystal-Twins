...
from dataset.augmentation import RotationTransformation, PerturbStructureTransformation, RemoveSitesTransformation,TranslateSitesTransformation
...
class CIFData(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        #translation_crys = translate_1.apply_transformation(crystal)
